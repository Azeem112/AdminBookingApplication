...
namespace BookingApplication.Controllers
{
    public class CustomerTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CompanyName,SingleorMulti,MultiNumber")] CustomerType customerType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CompanyName,SingleorMulti,MultiNumber")] CustomerType customerType)
        {
            if (ModelState.IsValid)
            {
